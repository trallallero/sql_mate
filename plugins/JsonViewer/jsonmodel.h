...
public:
    ...
    static JsonTreeItem* load(const QJsonValue& value, const QStringList& exceptions = {}, JsonTreeItem* parent = nullptr);
...
private:
    ...
    QJsonValue genJson(JsonTreeItem*) const;
};
